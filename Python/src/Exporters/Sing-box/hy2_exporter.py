"""Экспорт Hysteria2 нод в Sing-box JSON."""
...
def export_singbox(outbounds: list[dict], output_file: str = "hy2-sb.json") -> int:
    """Экспортирует Hysteria2 ноды в конфиг sing-box."""
    # Применяем speed settings для mobile
    for o in outbounds:
